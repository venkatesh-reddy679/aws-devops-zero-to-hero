...
docker pull 084828606525.dkr.ecr.us-east-2.amazonaws.com/test-image:22
docker run -dt -p 5000:5000 --name pythonapp 084828606525.dkr.ecr.us-east-2.amazonaws.com/test-image:22
docker ps
